...
Heterogeneous teams of UAVs and UGVs are assigned to sample direct normal irradiance across a
thermosolar plant. A receding-horizon allocation anticipates how the irradiance field will move,
so the robots are dispatched to where measurements will matter next rather than where they
matter now.
