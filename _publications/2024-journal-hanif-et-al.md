...
An angle-aware coverage controller that scales to large reconstruction areas by accounting for
the viewing angle each drone contributes to a surface, not just its position. The formulation
keeps the optimisation tractable as the map grows.
