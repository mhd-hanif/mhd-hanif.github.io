...
featured: true
bibtex: |
  @inproceedings{hanif2025mapfeedback,
    title     = {Impact of Real-time Map Feedback on Coordinated Image Sampling for 3D Reconstruction},
...
Aerial images are processed into a live 3D mesh with NeuralRecon; the mesh in turn reshapes the
importance density driving a QP-based coverage controller. Simulations in Unity and ROS2 show
the feedback loop improves reconstruction quality over open-loop sampling.
