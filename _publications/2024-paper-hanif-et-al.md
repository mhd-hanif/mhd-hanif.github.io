...
Tracking a moving target from the air is a trade-off: fly low for detection accuracy, fly high
for field of view. This work adapts both the drone's altitude and the object detection model
online so the pair stays matched to the target's behaviour.
